...
const projects = [
  {
    ...
    main: "	Built a React single-page app using React Router so pages load data before rendering and can submit forms (menu, order pages).",
  ...
  },
  {
    ...
    main: "Designed and developed a **Task Planner application** with priority-based task management (High, Medium, Low) to improve productivity and time management",
    liveUrl: "https://planner-blond-three.vercel.app/",
    repoUrl: "https://github.com/aneesh-kapoor/Planner",
  },

  {
    id: 3,
    title: "Visiting Card Designer ",
    main: "Created a **Visiting Card Designer** web app that allows users to design and customize their own visiting cards with various templates, colors, and fonts.",
    liveUrl: "https://visitindcard.vercel.app/",
    repoUrl: "https://github.com/aneesh-kapoor/visitindcard",
  },
  {
    id: 4,
    title: "Expensetracter ",
    main: "Developed an **Expense Tracker** web application that enables users to track their income and expenses, categorize transactions, and visualize spending patterns through charts and graphs.",
    liveUrl: "https://expensetracter.vercel.app/",
    repoUrl: "https://github.com/aneesh-kapoor/expensetracter",
  },
  {
    id: 5,
    title: "Currency-Convertor App ",
    main: "Built a **Currency Converter** web application that allows users to convert amounts between different currencies using real-time exchange rates from a public API.",
    liveUrl: "https://currency-convertor-psi.vercel.app/",
    repoUrl: "https://github.com/aneesh-kapoor/Currency-Convertor",   }
];
    ...
    <article className="bg-gray-900 border border-gray-700 rounded-lg p-6 w-full sm:w-[48%] md:w-[31%] flex flex-col justify-between shadow-lg">
      ...
      <div className="mt-4 flex flex-wrap gap-3">
        {liveUrl ? (
          ...
          <span className="inline-flex items-center gap-2 px-3 py-2 bg-gray-700 text-gray-400 text-sm rounded-md">
            No demo
          </span>
        )}
        ...
        {repoUrl ? (
          ...
          <span className="inline-flex items-center gap-2 px-3 py-2 border border-gray-700 text-sm text-gray-500 rounded-md">
            Private
          </span>
        )}
      </div>
      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-8 md:mb-12">
          ...
          <p className="text-gray-300 mt-2">
            Selected projects — click Live or Source to open in a new tab.
          </p>
        </header>
